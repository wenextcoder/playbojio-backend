        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GamePreferences = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WillingToHost = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    BlacklistedUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CostNotes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PrimaryGame = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AdditionalGames = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MinPlayers = table.Column<int>(type: "int", nullable: false),
                    MaxPlayers = table.Column<int>(type: "int", nullable: false),
                    GameTags = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsNewbieFriendly = table.Column<bool>(type: "bit", nullable: false),
