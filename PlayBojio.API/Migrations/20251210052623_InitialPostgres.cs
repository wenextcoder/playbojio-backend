        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredAreas = table.Column<string>(type: "text", nullable: true),
                    GamePreferences = table.Column<string>(type: "text", nullable: true),
                    WillingToHost = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Blacklists_AspNetUsers_BlacklistedUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CostPerPerson = table.Column<decimal>(type: "numeric", nullable: true),
                    CostNotes = table.Column<string>(type: "text", nullable: true),
                    PrimaryGame = table.Column<string>(type: "text", nullable: false),
                    AdditionalGames = table.Column<string>(type: "text", nullable: true),
                    MinPlayers = table.Column<int>(type: "integer", nullable: false),
                    MaxPlayers = table.Column<int>(type: "integer", nullable: false),
                    ReservedSlots = table.Column<int>(type: "integer", nullable: false),
                    IsHostParticipating = table.Column<bool>(type: "boolean", nullable: false),
                    GameTags = table.Column<string>(type: "text", nullable: true),
                    IsNewbieFriendly = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SessionWaitlists_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Blacklists_UserId_BlacklistedUserId",
                table: "Blacklists",
